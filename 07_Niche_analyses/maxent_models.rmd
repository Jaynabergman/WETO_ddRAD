...
## Extract envi value from under input localities
calling_locs_ext <- terra::extract(rstack, calling_locs[,c("Long_m", "Lat_m")])

calling_locs_ext <- calling_locs_ext %>%
  select(-ID)


noncalling_locs_ext <- terra::extract(rstack, noncalling_locs[,c("Long_m", "Lat_m")])

noncalling_locs_ext <- noncalling_locs_ext %>%
  select(-ID)
...
calling_mess <- predicts::mess(rstack, calling_locs_ext, full = FALSE, 
                               overwrite = TRUE, 
                               filename = "./Data/mess/calling_mess_tbg.tif")
...
## Run mess analysis and save prediction raster 
noncalling_mess <- predicts::mess(rstack, noncalling_locs_ext, full = FALSE, 
                               overwrite = TRUE, 
